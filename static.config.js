  ...
  Document: ({ Html, Head, Body, children }) => (
    <Html lang="en">
      <Head>
        ...
        <meta property="og:image" content={`${api.SITE_ROOT}${api.BASE_PATH}/images/fb-preview.png`} />
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-GKL6DDD6BV" />
